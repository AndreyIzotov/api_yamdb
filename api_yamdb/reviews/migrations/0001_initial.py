    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(help_text='Произведение, к которому относится отзыв', on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='title.Title', verbose_name='произведение')),
            ],
            options={
                'verbose_name': 'отзыв',
